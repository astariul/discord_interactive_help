...
root2 = Page('Welcome to this (fake) guild functionnality.\n\nHere we will see how you can make your bot even more interactive, by making each command completely interactive.\n\n')
page_guild = Page('What would you like to do ?\n')
page_guild_display = Page('') # Here we don't display any static content. Content will be displayed by callback, dynamically
...
page_guild_register2.link([page_guild_end1, page_guild_end2], is_parent=False, callbacks=congrats, user_input=True)   # We set user_input to true, so this is a Message Link. And we don't want to have a parent link
page_guild_register.link(page_guild_register2, is_parent=False, user_input=True)
page_guild.link(page_guild_display, reaction='👁', description='Get the list of existing guilds', callbacks=display_guild_list)
...
# And root it
root2.root_of([page_guild, page_guild_display, page_guild_register, page_guild_register2, page_guild_end1, page_guild_end2])
